class Unit < ActiveRecord::Base
  ...
  attr_accessible :address_1, :address_2, :author_username, :city, :description, :facebook, :museum, :postal_code, :primary_email, :primary_phone, :social_links_attributes, :state, :unit_name, :website, :unit_logo
